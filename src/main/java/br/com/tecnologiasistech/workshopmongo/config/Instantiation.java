package br.com.tecnologiasistech.workshopmongo.config;
...
import br.com.tecnologiasistech.workshopmongo.dto.AuthorDTO;
import br.com.tecnologiasistech.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Acordeu feliz hoje!", new AuthorDTO(maria));
